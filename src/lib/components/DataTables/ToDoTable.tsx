...
export default function ToDoTable({
  ...
  taskType: string;
  initialLoadRef: React.RefObject<boolean>;
}) {
      ...
      try {
        if (initialLoadRef.current) {
          ...
          const uniquePositions = [
            ...new Set(
              response.data.map((candidate: any) => candidate.jobTitle)
            ),
          ];
          setPositionOptions([
            { name: "All Careers" },
            ...uniquePositions.map((position: string) => ({ name: position })),
          ]);
      ...
      >
        ...
        >
          <CustomDropdown
            ...
            valuePrefix="Sort by:"
          />
          {taskType !== "retake-interview-requests" && (
            <CustomDropdown
              value={filterAssessment}
              setValue={setFilterAssessment}
        ...
        <div
          style={{
            ...
            flexDirection: "row",
            gap: "10px",
            width: taskType !== "retake-interview-requests" ? "60%" : "100%",
                        ...
                        <CareerFit
                          ...
                          assessment={
                            ...
                            candidate?.stage === "Pending AI Interview"
                              ...
                              : extractInterviewAssessment(candidate?.summary)
                          }
                        />
                      </td>
                      <td>
                      ...
                      <td>
                        ...
                        >
                          <i
                            ...
                            style={{ fontSize: 20, color: "#787486" }}
                          ></i>
                        </button>
                      </td>
                    </tr>
