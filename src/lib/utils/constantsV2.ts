...
export const assetConstants = {
  ...
  alertCircle: iconsPath + "alert-circle.svg",
  ...
  arrowWhite: iconsPath + "arrow-right.svg",
  ...
  circleDown: iconsPath + "circle-down.svg",
  ...
  error: iconsPath + "alert-triangle.svg",
  ...
  numbers: iconsPath + "123.svg",
  pending: iconsPath + "pending.svg",
  plus: iconsPath + "plus.svg",
  plusDark: iconsPath + "plus-dark.svg",
  ...
  starsMono: iconsPath + "auto-awesome.svg",
  subject: iconsPath + "subject.svg",
  textBold: iconsPath + "text-bold.svg",
  textItalic: iconsPath + "text-italic.svg",
  textUnderline: iconsPath + "text-underline.svg",
  textStrikethrough: iconsPath + "text-strikethrough.svg",
  textNumberedList: iconsPath + "text-numbered.svg",
  textBulletList: iconsPath + "text-bullet.svg",
  tips: iconsPath + "tips.svg",
  trash: iconsPath + "trash.svg",
  trashV2: iconsPath + "trash-2.svg",
  ...
  videocam: iconsPath + "videocam.svg",
  x: iconsPath + "x.svg",
  xV2: iconsPath + "xV2.svg",
  xV3: iconsPath + "xV3.svg",
  xV4: iconsPath + "xV4.svg",
